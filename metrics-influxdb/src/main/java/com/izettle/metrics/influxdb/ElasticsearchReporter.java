...
public final class ElasticsearchReporter extends ScheduledReporter {
    public static class Builder {
        ...
        public ElasticsearchReporter build(final ElasticsearchSender influxDb) {
    ...
    private final ElasticsearchSender elasticsearch;
    ...
    private ElasticsearchReporter(
        ...
        final ElasticsearchSender elasticsearch,
    ...
    public void report(
        ...
        try {
            ...
            if (elasticsearch.hasSeriesData()) {
                elasticsearch.writeData();
            }
    ...
    private void reportGaugeGroup(String name, Map<String, Gauge> gaugeGroup, long now) {
        ...
        tags.putAll(elasticsearch.getTags());
        tags.put("metricName", name);

        if (!fields.isEmpty()) {
            elasticsearch.appendPoints(
                new InfluxDbPoint(
